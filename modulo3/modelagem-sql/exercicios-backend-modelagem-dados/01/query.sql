...
VALUES
  (REPLACE(REPLACE('825.398.410-31', '.', ''), '-', ''), 'Rodrigo Sampaio'),
  (REPLACE(REPLACE('232.625.460-03', '.', ''), '-', ''), 'Beatriz Souza Santos'),
  (REPLACE(REPLACE('280.071.550-23', '.', ''), '-', ''), 'Carlos Eduardo');

INSERT INTO pedidos (valor, cliente_cpf, vendedor_cpf)
VALUES
(300+700+(6*1200)+1000+(90*5), '80371350042', '28007155023');
